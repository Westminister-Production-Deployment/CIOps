        ...
        node(POD_LABEL) {
            try {
                ...
                if (currentBuild.result == 'SUCCESS') {
                    ...
                    emailext body: "Docker image for the ${JOB_BASE_NAME} service has been successfully build! 🎉\nRepository: DIGIT-OSS\nBranch: ${env.BRANCH.split('/')[-1]}\nDocker Image pushed to Docker Hub.", subject: "Docker Image Build and Push Successful: ${JOB_BASE_NAME}", to: 'ibrahim@westminister.tech,cc:godwyn@westminister.tech,cc:raymond@westminister.tech,cc:devops.consulting@ongraph.com'
                } else {
                    slackSend (
                        botUser: true,
                        color: 'danger',
